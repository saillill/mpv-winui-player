...
namespace mpv_winui.Modules.Language
{
    ...
    public partial class AppLang
    {
        ...
        public string SettingsGroupProgramConfigFiles { get; set; } = "Program config & files";
        public string SettingsGroupProgramDiagnostics { get; set; } = "Diagnostics & testing";
        public string SettingsGroupPlaybackNavigation { get; set; } = "Navigation & reverse playback";
        public string SettingsGroupFilesPlaylists { get; set; } = "Files & playlists";
        public string SettingsGroupNetworkCache { get; set; } = "Network & cache";
        public string SettingsGroupVideoDecodeSync { get; set; } = "Decode & sync";
        public string SettingsGroupVideoImageFilters { get; set; } = "Picture & filters";
        public string SettingsGroupGpuRendering { get; set; } = "GPU rendering";
        public string SettingsGroupColorHdr { get; set; } = "Color & HDR";
        public string SettingsGroupAudioOutput { get; set; } = "Audio output";
        public string SettingsGroupAudioVolume { get; set; } = "Volume & gain";
        public string SettingsGroupAudioExternalCover { get; set; } = "External audio & cover art";
        public string SettingsGroupSubtitleText { get; set; } = "Text subtitle style";
        public string SettingsGroupSubtitleAss { get; set; } = "ASS subtitle engine";
        ...
        public string SettingsGroupOsdMetadata { get; set; } = "OSD metadata";
        public string SettingsGroupScreenshotLocation { get; set; } = "Screenshot location";
        public string SettingsGroupScreenshotQuality { get; set; } = "Screenshot quality";
        ...
        public string SectionSubtitleFilter { get; set; } = "Subtitle filtering";
        public string SectionDescSubtitleFilter { get; set; } = "Clean non-dialogue text out of accessibility subtitles";
        ...
        public string SectionOsdText { get; set; } = "OSD text";
        public string SectionDescOsdText { get; set; } = "Size, font and typography";
        ...
        public string OptionValueMatchingAudioForced { get; set; } = "Forced only";
        public string OptionValueForcedAlways { get; set; } = "Any subtitle";
        ...
        public string OptionValueOsdMarkerNone { get; set; } = "None";
        public string OptionValueOsdMarkerTriangle { get; set; } = "Triangle";
        public string OptionValueOsdMarkerLine { get; set; } = "Line";
        ...
        public string SettingsOsdMarginYOffset { get; set; } = "OSD vertical offset";
        public string SettingsHelpOsdMarginYOffset { get; set; } = "Moves the OSD up or down from where it normally sits (positive is upward). Use it to dodge one part of the picture without changing the margins.";
        public string SettingsOsdScaleByWindow { get; set; } = "Scale OSD with the window";
        public string SettingsHelpOsdScaleByWindow { get; set; } = "Lets the OSD grow and shrink with the window (on by default). Keeps it from looking oversized in a small window, and enlarges it again in fullscreen.";
        public string SettingsOsdSelectedOutlineColor { get; set; } = "Selection outline colour";
        public string SettingsHelpOsdSelectedOutlineColor { get; set; } = "Outline colour of that highlighted item's text, black by default. It is what keeps the letters legible on a bright highlight.";
        public string SettingsOsdSelectedColor { get; set; } = "OSD selection colour";
        public string SettingsHelpOsdSelectedColor { get; set; } = "Colour of the highlighted item in mpv's own OSD lists, amber by default. Only visible when an mpv OSD menu is in use, such as chapters or the playlist.";
        public string SettingsOsdBackColor { get; set; } = "OSD background";
        public string SettingsHelpOsdBackColor { get; set; } = "The fill behind OSD text, semi-transparent black by default. It is what keeps the OSD readable over busy pictures; making it fully transparent leaves only the outline and shadow.";
        public string SettingsOsdShaper { get; set; } = "OSD glyph shaping";
        public string SettingsHelpOsdShaper { get; set; } = "How the OSD font turns characters into glyphs. Complex (the default) renders joined scripts such as Arabic and Devanagari correctly; simple costs less. For Latin and CJK it makes no difference.";
        public string SettingsOsdFontProvider { get; set; } = "Font provider";
        public string SettingsHelpOsdFontProvider { get; set; } = "Where OSD fonts come from. Auto picks the sensible option for the platform; Fontconfig suits a system with its own fontconfig setup; None falls back to built-in fonts only. A wrong choice usually shows up as boxes instead of letters.";
        public string SettingsOsdFontsDir { get; set; } = "Extra font folder";
        public string SettingsHelpOsdFontsDir { get; set; } = "Where the OSD looks for extra fonts. Only needed to render the OSD in a font the system does not have. Note that ASS subtitles search the same place.";
        public string SettingsOsdShadowOffset { get; set; } = "OSD shadow offset";
        public string SettingsHelpOsdShadowOffset { get; set; } = "Distance of the drop shadow behind OSD text (default 0, off). It is a different readability aid from the outline: the outline rings the glyph, the shadow darkens one side, which reads more like print.";
        public string SettingsOsdJustify { get; set; } = "OSD alignment";
        public string SettingsHelpOsdJustify { get; set; } = "How multi-line OSD text is aligned. Auto decides from the content; pinning left or right stops long filenames from jumping around as they wrap.";
        public string SettingsOsdItalic { get; set; } = "Italic OSD";
        public string SettingsHelpOsdItalic { get; set; } = "Draws OSD text italic. A font without a true italic gets skewed instead, which can look slightly muddy.";
        public string SettingsOsdBold { get; set; } = "Bold OSD";
        public string SettingsHelpOsdBold { get; set; } = "Draws OSD text bold, which reads better over a bright picture. Matters most at small sizes or on a high-DPI screen.";
        public string SettingsOsdSpacing { get; set; } = "OSD letter spacing";
        public string SettingsHelpOsdSpacing { get; set; } = "Extra space between OSD characters, positive or negative (default 0). A small positive value helps when the font sets them too tightly.";
        public string SettingsOsdScale { get; set; } = "OSD scale";
        public string SettingsHelpOsdScale { get; set; } = "Scales the whole OSD on top of the font size (default 1). After moving to a bigger screen the OSD looks small; this grows everything at once instead of each size field.";
        ...
        public string SettingsHelpSubFilterSdhHarder { get; set; } = "Deletes bracketed text even when it reads like dialogue. Some releases wrap entire lines that way, which needs this on; if brackets appear legitimately in the dialogue, it will take them too.";
        public string SettingsHelpSubFilterSdhEnclosures { get; set; } = "The characters treated as enclosing a sound description. The default, (),[],（）， is a round pair, a square pair and a full-width pair. Narrowing this avoids deleting brackets that are part of the dialogue.";
        public string SettingsHelpSubFilterSdh { get; set; } = "Removes the hearing-impaired cues from SDH subtitles, such as [knocking] or [music]. They are recognised by their brackets, and anyone who can hear finds them noise.";
        public string SettingsHelpSecondarySubAssOverride { get; set; } = "Whether the second track applies ASS styling. Match it to the main subtitle's setting so the two are handled the same way; otherwise they can look inconsistent.";
        public string SettingsHelpSubBitmapMaxSize { get; set; } = "Largest decoded size allowed for bitmap subtitles such as PGS and VobSub; 0 means no limit (the default). Lowering it stops huge graphics subtitles eating VRAM, at the cost of those subtitles not showing at all.";
        public string SettingsHelpSubAssPruneDelay { get; set; } = "How long off-screen ASS events are kept before being discarded, in seconds (-1 keeps them forever, the default). Keeping them makes scrolling smoother; complex effects then hold memory.";
        public string SettingsHelpSubAssJustify { get; set; } = "Justifies multi-line ASS subtitles instead of centring each line. Dialogue that was laid out with spaces looks better; effects subtitles that position with spaces can shift.";
        public string SettingsHelpSubMarginYOffset { get; set; } = "Moves subtitles up or down from where they normally sit (positive is upward). Use it to nudge them without changing the margins.";
        public string SettingsHelpSubGauss { get; set; } = "Blurs subtitle edges with a Gaussian (0-3; 0 is off). Softens the letterforms. Higher values get visibly fuzzy and harder to read.";
        public string SettingsHelpSubOutlineColor { get; set; } = "Colour of the outline around subtitle text, black by default. It is what separates the letters from a bright background. ASS subtitles carry their own styling and ignore this.";
        public string SettingsHelpSubSpacing { get; set; } = "Extra space between letters, positive or negative (default 0). A small positive value helps when a font sets them too tightly.";
        public string SettingsHelpSubScale { get; set; } = "Scales subtitles on top of whatever size the font already asks for (default 1). Use it when a release ships small text, or after moving to a bigger screen.";
        public string SettingsHelpSubShaper { get; set; } = "How the subtitle font turns characters into glyphs. Complex (the default) handles joined scripts such as Arabic and Devanagari; simple is faster but renders those wrongly. For Latin and CJK it makes no difference.";
        public string SettingsHelpSubForcedEventsOnly { get; set; } = "Within one track, show only the events marked forced - the ones translating foreign dialogue. Useful for watching a foreign film with the original audio.";
        public string SettingsHelpSubsFallbackForced { get; set; } = "What to do when the two rules above find nothing: no subtitles, forced ones only, or any subtitle at all.";
        public string SettingsHelpSubsWithMatchingAudio { get; set; } = "Only auto-select a subtitle whose language matches the audio. Forced only restricts this to forced tracks. Stops an English dub picking up English subtitles.";
        public string SettingsHelpSubsMatchOsLanguage { get; set; } = "When picking a subtitle track automatically, prefer the one matching the interface language. Saves picking by hand on releases with several tracks.";
        public string SettingsHelpSubFixTimingThreshold { get; set; } = "Two subtitles are only merged when they are closer than this many milliseconds (default 210). Lower it to be more conservative and only touch clear overlaps.";
        public string SettingsHelpSubFixTiming { get; set; } = "Repairs badly authored subtitles: entries that overlap or flash by too fast are adjusted until they are readable. Helpful for sloppy releases, harmless for clean ones.";
        public string SettingsHelpSubVisibility { get; set; } = "Master switch for subtitles. Turning it off still loads subtitle files, it just stops drawing them.";
        public string SettingsSubFilterSdhHarder { get; set; } = "Filter more aggressively";
        public string SettingsSubFilterSdhEnclosures { get; set; } = "Bracket characters";
        public string SettingsSubFilterSdh { get; set; } = "Filter SDH descriptions";
        public string SettingsSecondarySubAssOverride { get; set; } = "Second track ASS styling";
        public string SettingsSubBitmapMaxSize { get; set; } = "Bitmap subtitle size limit";
        public string SettingsSubAssPruneDelay { get; set; } = "ASS event retention";
        public string SettingsSubAssJustify { get; set; } = "Justify ASS subtitles";
        public string SettingsSubMarginYOffset { get; set; } = "Vertical offset";
        public string SettingsSubGauss { get; set; } = "Subtitle edge blur";
        public string SettingsSubOutlineColor { get; set; } = "Subtitle outline colour";
        public string SettingsSubSpacing { get; set; } = "Subtitle letter spacing";
        public string SettingsSubScale { get; set; } = "Subtitle scale";
        public string SettingsSubShaper { get; set; } = "Glyph shaping";
        public string SettingsSubForcedEventsOnly { get; set; } = "Forced events only";
        public string SettingsSubsFallbackForced { get; set; } = "Fall back to forced";
        public string SettingsSubsWithMatchingAudio { get; set; } = "Match the audio language";
        public string SettingsSubsMatchOsLanguage { get; set; } = "Prefer the interface language";
        public string SettingsSubFixTimingThreshold { get; set; } = "Merge threshold (ms)";
        public string SettingsSubFixTiming { get; set; } = "Fix subtitle timing";
        public string SettingsSubVisibility { get; set; } = "Show subtitles";
