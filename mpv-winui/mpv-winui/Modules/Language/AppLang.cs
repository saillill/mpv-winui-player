...
namespace mpv_winui.Modules.Language
{
    ...
    public partial class AppLang
    {
        ...
        public string SettingsCategoryFiles { get; set; } = "Files & Playlist";
        ...
        public string SectionGeneralAppearance { get; set; } = "Appearance";
        public string SectionGeneralLanguageLog { get; set; } = "Language & logging";
        public string SectionGeneralWindow { get; set; } = "Window";
        public string SectionPlaybackBehavior { get; set; } = "Playback behavior";
        public string SectionPlaybackNetwork { get; set; } = "Cache & network";
        public string SectionFilesPlaylist { get; set; } = "Auto playlist";
        public string SectionFilesWatchLater { get; set; } = "Watch later";
        public string SectionVideoScaling { get; set; } = "Scaling & quality";
        public string SectionVideoSync { get; set; } = "Sync & interpolation";
        public string SectionVideoHdr { get; set; } = "HDR & color";
        public string SectionVideoDecode { get; set; } = "Decoding";
        public string SectionAudioTracks { get; set; } = "Tracks & language";
        public string SectionAudioOutput { get; set; } = "Output & latency";
        public string SectionAudioFiles { get; set; } = "Files & cover art";
        public string SectionSubtitleBasic { get; set; } = "Text subtitles";
        ...
        public string SectionScreenshotQuality { get; set; } = "Encoding quality";
        public string SectionAdvancedColor { get; set; } = "Color management";
        public string SectionAdvancedCache { get; set; } = "Cache & disk";
        public string SectionAdvancedOsd { get; set; } = "OSD";
        public string SectionAdvancedPlugins { get; set; } = "Plugins";
        public string SectionAdvancedFolders { get; set; } = "Folders";
        public string SectionAdvancedService { get; set; } = "Network & services";
