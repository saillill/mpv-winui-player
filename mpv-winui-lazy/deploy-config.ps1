...
robocopy $src $Target /MIR /XD _cache cache watch_later gpu_cache icc_cache /XF saved-props.json recent.json menus.json *.log *.bak* /NFL /NDL /NJH /NJS /NP | Out-Null
$code = $LASTEXITCODE
